...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber" '("*jabber-status-history*" "jabber-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-alert" '("beep" "define-" "echo" "jabber-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-avatar" '("avatar" "jabber-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-conn" '("*jabber-virtual-server-function*" "jabber-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-iq" '("*jabber-open-info-queries*" "jabber-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-libnotify" '("jabber-libnotify-" "libnotify")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-muc-nick-completion" '("*jabber-muc-participant-last-speaking*" "jabber-" "try-expand-jabber-muc")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-ratpoison" '("jabber-ratpoison-message" "ratpoison")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-sawfish" '("jabber-sawfish-display-" "sawfish")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-screen" '("jabber-screen-message" "screen")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-tmux" '("jabber-tmux-message" "tmux")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-widget" '("jabber-" "jid-complete")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-wmii" '("jabber-wmii-" "wmii")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jabber-xmessage" '("jabber-xmessage-" "xmessage")))
